...
namespace arcgen::planner::constraints
{
    ...
    template <std::size_t N> class FootprintCollisionConstraint final : public HardConstraint<N>
    {
      ...
      private:
         ...
         * @param tol Curvature tolerance.
         * @return True if |curvature| <= tol.
         */
        static bool isStraight (const State &s, double tol) { return std::fabs (s.curvature) <= tol; }

        /**
         * @brief Check if a single state is safe.
         * @param ws    Workspace to check against.
         * @param robot Robot footprint.
         * @param s     State to check.
         * @return True if robot footprint at s is covered by workspace.
         */
         ...
         * @return True if all states in range are safe.
         */
         ...
         * @param states Path states.
         * @param start  Start index of the run.
         * @param tol    Curvature tolerance.
         ...
         * @param ws     Workspace to check against.
         * @param robot  Robot footprint.
         * @param sStart State at start of run.
         * @param sEnd   State at end of run.
         * @return True if hull is covered by workspace.
         */
         ...
         * @param robot        Robot footprint.
         * @param states       Path states to check.
         * @param curvatureTol Tolerance for straightness check.
         * @return True if valid, false if collision found.
         */
